      ...
      >
        <div className="upside-down-glow bg-black/70 backdrop-blur-2xl border border-red-900/30 p-10 rounded-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-10 relative">
            ...
            >
              <Zap className="w-8 h-8 text-red-500 drop-shadow-[0_0_10px_rgba(220,38,38,0.9)]" />
            </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="eleven@hawkinslab.gov"
              />
            </div>
            <div>
              <label className="block text-[10px] font-semibold text-red-400/60 uppercase tracking-[0.2em] mb-2">
            ...
            >
              ...
              <span className="relative">{loading ? 'Verifying access...' : 'Enter the Upside Down'}</span>
            </motion.button>
          </form>
